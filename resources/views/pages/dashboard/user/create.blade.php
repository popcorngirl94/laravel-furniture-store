            ...
            <form action="{{ route('dashboard.product.store') }}" class="w-full" method="post" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="w-full px-3">
                        ...
                        <input type="text" value="{{ old('name') }}" placeholder="Product Name" name="name" class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 ">
                    </div>
                    </div>
                    ...
                    <div class="w-full px-3">
                        ...
                        <input type="number" value="{{ old('price') }}" placeholder="Product Price" name="price" class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                    </div>
                    </div>
